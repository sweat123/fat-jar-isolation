...
import com.laomei.fatjar.common.boot.tool.DefaultLayoutFactory;
import com.laomei.fatjar.common.boot.tool.Layout;
import com.laomei.fatjar.common.boot.tool.LayoutFactory;
import com.laomei.fatjar.common.boot.tool.Libraries;
import com.laomei.fatjar.common.boot.tool.Library;
import com.laomei.fatjar.common.boot.tool.LibraryCallback;
import com.laomei.fatjar.common.boot.tool.RepackagingLayout;
	...
	private boolean alreadyRepackaged() throws IOException {
		...
		try {
			...
			return (manifest != null && manifest.getMainAttributes()
					.getValue(FAT_JAR_TOOL_VALUE) != null);
		}
		finally {
			jarFile.close();
		}
